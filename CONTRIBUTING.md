...
4. **Universal Bootloader:** The skill's `SKILL.md` must include the standard `<!-- REACTIVE BOOTLOADER -->` referencing `reactive-skills-axi state <skill>`.
...
- [ ] Does `SKILL.md` contain the universal bootloader with `reactive-skills-axi`?
